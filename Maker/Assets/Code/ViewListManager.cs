...
public class ViewListManager : SceneManagement, IDataPersistence
{
    ...
    private void Start()
    {
        ...
        //Uncomment this if-Block if the view Manager in Unity wont be hold as it happens with the partManager
        //if (viewManager == null)
        //{
        //    viewManager = this.transform.parent.parent.parent.GetComponentInParent<ViewManager>();
        //}
    ...
    public void displayView(View view)
    {
        ...
        viewObject.GetComponent<ViewLink>().manager = viewManager;
    ...
    public void LoadData(ConfigData data)
    {
        ...
        else
        {
            ...
            //Uncomment the two comments if the view Manager in Unity wont be hold as it happens with the partManager
            //ViewManager viewMangerTemp = viewManager;
