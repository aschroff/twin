...
{
    public class Fillers: Tools, IRoot
    {

        public override string GetBegin()
        {
            return "Following is a list of meaning for surfaces (not lines) painted on the body. The value in brackets are RGB codes of the colours: ";
        }
