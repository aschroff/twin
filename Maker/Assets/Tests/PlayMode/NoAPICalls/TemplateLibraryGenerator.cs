...
namespace NoAPICalls
{
    ...
    public class TemplateLibraryGenerator : PlayModeTestBase
    {
        ...
        [UnityTest, Timeout(900000)] public IEnumerator Batch01_TorsoFront() { yield return RunBatch("torso_front"); }
        [UnityTest, Timeout(900000)] public IEnumerator Batch02_TorsoBack() { yield return RunBatch("torso_back"); }
        [UnityTest, Timeout(900000)] public IEnumerator Batch03_ArmsFront() { yield return RunBatch("arms_front"); }
        [UnityTest, Timeout(900000)] public IEnumerator Batch04_ArmsBack() { yield return RunBatch("arms_back"); }
        [UnityTest, Timeout(900000)] public IEnumerator Batch05_LegsFront() { yield return RunBatch("legs_front"); }
        [UnityTest, Timeout(900000)] public IEnumerator Batch06_LegsBack() { yield return RunBatch("legs_back"); }
        [UnityTest, Timeout(900000)] public IEnumerator Batch07_HeadNeck() { yield return RunBatch("head_neck"); }
        [UnityTest, Timeout(900000)] public IEnumerator Batch08_Hands() { yield return RunBatch("hands"); }
        [UnityTest, Timeout(900000)] public IEnumerator Batch09_ExtendedMisc() { yield return RunBatch("extended_misc"); }
